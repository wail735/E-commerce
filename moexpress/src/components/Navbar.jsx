...
import { Search, User, ShoppingCart, Package, MapPin, Menu, X, ChevronRight, Heart, Moon, Sun, Globe } from "lucide-react";
                ...
                <div className="container mx-auto px-3 sm:px-4 lg:px-6">
                    ...
                    <div className="h-[64px] sm:h-[70px] flex items-center gap-2 sm:gap-3 lg:gap-5">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2 lg:gap-4 ml-auto shrink-0">
                            ...
                            <Link to="/orders" className="hidden lg:flex items-center gap-2 px-2 py-1.5 rounded-lg text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                <Package size={21} />
                                <div className="flex flex-col">
            ...
            <div className={`fixed inset-0 z-[100] flex lg:hidden transition-all duration-300 ${open ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                ...
                <div className={`relative w-4/5 max-w-sm bg-white dark:bg-[#0B1120] h-full shadow-2xl flex flex-col transition-transform duration-300 ease-out ${open ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    <div className="flex-1 overflow-y-auto py-2">
                        ...
                        <Link to="/orders" onClick={closeMenu} className="flex items-center justify-between px-5 py-3.5 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary border-b border-gray-100 dark:border-gray-800">
