...
import { LogOut, User, Mail, Shield, Settings, Store, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sm:p-8">
            ...
            {/* Seller Section */}
            <div className="mt-10 p-6 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/10 rounded-2xl border border-orange-100 dark:border-orange-500/20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">
                    {user.role === 'seller' ? 'Espace Vendeur' : 'Vendre sur MoExpress'}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    {user.role === 'seller' 
                      ? 'Gérez vos produits, vos commandes et suivez vos revenus en temps réel.'
                      : 'Ouvrez votre boutique en quelques clics et commencez à vendre vos produits à des millions de clients.'}
                  </p>
                  
                  {user.role === 'seller' ? (
                    <button 
                      onClick={() => navigate('/seller/dashboard')}
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FF4D20] text-white font-bold rounded-xl hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30"
                    >
                    ...
                    <button 
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-bold rounded-xl hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors"
                    >
                      Devenir Vendeur
                      <ArrowRight size={16} />
                    </button>
