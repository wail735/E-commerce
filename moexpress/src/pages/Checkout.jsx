...
const Checkout = () => {
  ...
  const handleCheckout = () => {
    ...
    if (paymentMethod === 'credit-card') {
      ...
      if (!data.expirationDate) newErrors.expirationDate = "Expiration is required";
      if (!data.securityCode) newErrors.securityCode = "Security code is required";
      ...
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-50 dark:bg-[#0B1120] transition-colors duration-300 px-4 py-20">
        <div className="bg-white dark:bg-gray-800 p-8 md:p-12 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 max-w-lg w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/orders" className="px-8 py-3.5 bg-gray-900 dark:bg-gray-700 text-white font-bold rounded-xl hover:bg-black dark:hover:bg-gray-600 transition-colors">
              {t('view_order')}
            </Link>
                  ...
                  <div className="p-4 bg-white dark:bg-gray-800 space-y-4">
                    <div>
                      <input 
                        ...
                        className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all ${errors.cardNumber ? 'border-red-300 dark:border-red-500/50 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 dark:border-gray-700 focus:border-[#FF4D20] focus:ring-orange-500/10'}`}
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <input 
                        ...
                        className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all ${errors.expirationDate ? 'border-red-300 dark:border-red-500/50 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 dark:border-gray-700 focus:border-[#FF4D20] focus:ring-orange-500/10'}`}
                      />
                      <input 
                        type="text" 
                        name='securityCode'
                        ...
                        className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all ${errors.securityCode ? 'border-red-300 dark:border-red-500/50 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 dark:border-gray-700 focus:border-[#FF4D20] focus:ring-orange-500/10'}`}
                      />
                    </div>
                    <div>
                      <input 
                        ...
                        className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all ${errors.nameOnCard ? 'border-red-300 dark:border-red-500/50 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 dark:border-gray-700 focus:border-[#FF4D20] focus:ring-orange-500/10'}`}
                      />
                    </div>
                  </div>
                )}
                  ...
                  cartItems.map((item) => (
                    <div key={item.cartId} className="flex gap-4">
                      <div className="relative w-16 h-16 rounded-xl border border-gray-100 dark:border-gray-700 bg-[#F7F7F8] flex-shrink-0">
                        <img src={item.image} alt={t(`prod_${item.slug.replace(/-/g, '_')}`)} className="w-full h-full object-contain p-2 mix-blend-multiply" />
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        <h4 className="text-sm font-semibold text-gray-900 dark:text-white line-clamp-1">{t(`prod_${item.slug.replace(/-/g, '_')}`)}</h4>
